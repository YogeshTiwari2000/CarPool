...
import { close, arrowDown, star, search, home, person, pin, navigate, location } from 'ionicons/icons';
...
export class AppComponent {
  ...
  constructor() {
    addIcons({ close, arrowDown, star, search, home, person, pin, navigate, location });
